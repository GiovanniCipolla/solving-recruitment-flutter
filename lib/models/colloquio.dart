...
class Colloquio {
  ...
  factory Colloquio.fromJson(Map<String, dynamic> json) {
    ...
    return Colloquio(
      ...
      candidato: json['candidato'] != null ? Candidato.fromJson(json['candidato']) : null,
      selezionatore: json['selezionatore'] != null ? Selezionatore.fromJson(json['selezionatore']) : null,
    );
  }
